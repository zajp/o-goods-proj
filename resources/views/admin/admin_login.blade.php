...
<head>
    ...
    <link rel="stylesheet" href="{{ ('css/backend_css/bootstrap-responsive.min.css') }}" />
        <link rel="stylesheet" href="{{ ('css/backend_css/matrix-login.css') }}" />
    ...
    <body>
        <div id="loginbox">            
         ...
         <div class="control-group normal_text"> <h3><img src="{{ asset ('images/backend_images/OgoodsAdminLogo.png') }}" alt="Logo" /></h3></div>
